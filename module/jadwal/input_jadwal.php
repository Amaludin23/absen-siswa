						...
						<form method="post" role="form" action="././module/simpan.php?act=input_jadwal">
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<input type="time" class="form-control" required placeholder="Jam Mulai"
										name="jam_mulai">
								</div>
								<div class="form-group">
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<input type="time" class="form-control" name="jam_mulai"
										value="<?php echo "$rsx[jam_mulai]"; ?>">

								</div>
								<div class="form-group">
									<label>Jam Selesai</label>
									<input type="time" class="form-control" value="<?php echo "$rsx[jam_selesai]"; ?>"
										name="jam_selesai">
								</div>
							</div>

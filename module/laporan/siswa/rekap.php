...
$sqlrss=mysqli_query($koneksi,"select * from siswa where nis='$uidi'");
...
<?php
$sqlabsen=mysqli_query($koneksi,"select DISTINCT tgl from absen where idj='$acuan' AND ids='$siswa[ids]'");
 ?>
<table class="table table-striped table-bordered table-hover">
  ...
  <tr>
    ...
    <?php
    $sqlabsen2=mysqli_query($koneksi,"select ket from absen where ids='$siswa[ids]' AND idj='$acuan' AND tgl='$tglnya[tgl]'");

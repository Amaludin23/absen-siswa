            ...
            <?php
            	$sql=mysqli_query($koneksi,"select * from guru where nip='$uidi'");
...
<?php
$no=1;
    $query = "select jadwal.idj , hari.hari , kelas.nama AS nama_kelas, guru.idg AS id_guru, mata_pelajaran.nama_mp

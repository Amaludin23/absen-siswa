                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                      <ul class="nav nav-tabs">
                    	  ...
                    	  <li role="presentation" class="active"><a href="media.php?module=selasa">Selasa</a></li>
...
<?php
$no=1;
    $query = "select jadwal.idj , hari.hari , kelas.nama AS nama_kelas, guru.nama AS nama_guru, mata_pelajaran.nama_mp
